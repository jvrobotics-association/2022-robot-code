...
public class TeleopDriveCommand extends CommandBase {
    ...
    private final DriverControls driverControls = RobotContainer.CONTROLS.getDriverControls();
    ...
    public void execute() {
        ...
        double vx = forward * Constants.DriveConstants.MAX_SPEED_METERS_PER_SECOND;
        double vy = strafe * Constants.DriveConstants.MAX_SPEED_METERS_PER_SECOND;
        double omega = yaw * Constants.DriveConstants.MAX_OMEGA;
